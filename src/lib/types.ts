...
export type ActivityType = 'project_created' | 'deliverable_uploaded' | 'deliverable_status_changed' | 'invoice_sent' | 'invoice_paid' | 'message_sent';
...
export interface ActivityLog {
  ...
  type: ActivityType;
  description: string;
  resourceId?: string; // e.g., projectId, deliverableId
  createdAt: Date;
}
...
export interface ProjectReport {
  ...
  upcomingMilestones: ProjectStage[];
